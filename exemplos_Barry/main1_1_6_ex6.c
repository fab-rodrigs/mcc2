...
int main (void)
{
	  ...
	  xTaskCreate(vContinuousProcessingTask, "Task 1", 254, (void *) pcTextForTask1, 1, NULL);
	  xTaskCreate(vContinuousProcessingTask, "Task 2", 254, (void *) pcTextForTask2, 1, NULL);
	  xTaskCreate(vPeriodicTask,"Task 3", 254, NULL, 2, NULL);
