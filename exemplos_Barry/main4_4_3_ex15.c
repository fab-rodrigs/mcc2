...
int main (void)
{
	 ...
	 * pode ser empregado o ADC com algum entrada flutuante para gerar a aleatoriedade desse nr.
	 */
	...
	if(xMutex != NULL)
	{
		xTaskCreate(prvPrintTask, "Print1", 256, "Task1 ----------------- = ", 1, NULL);
		xTaskCreate(prvPrintTask, "Print2", 256, "Task2 ***************** = ", 2, NULL);
