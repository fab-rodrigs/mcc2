...
void vTask1(void *pvParameters)
{
	...
	while(1)
	{
		...
		xTaskCreate(vTask2, "Tarefa 2", 256, NULL, 2, &xTask2Handle);
 ...
 * depois que a tarefa for excluida. Alocação dinámica versus estática.
 */
...
int main (void)
{
	  ...
	  xTaskCreate(vTask1,"Tarefa 1",256, NULL, 1, NULL);
