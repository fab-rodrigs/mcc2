...
asm (".equ fcpu, 96000000/2 \n\t");				//define a frequencia para o uso em c�digo assembly
asm (".equ const_ms, fcpu/3000		 \n\t");	//constante para o atraso_ms
asm (".equ const_us, fcpu/3000000	 \n\t");	//constante para o atraso_us

/*	Colocar o argumento igual a ZERO resultara no maximo atraso possivel para a função.
	Nao existe teste contra zero, visto que é um valor ilógico para a função	*/
...
void atraso_us(uint32_t valor);		//valor maximo de 153.000.000
void atraso_ms(uint32_t valor);		//valor maximo de 153.000
